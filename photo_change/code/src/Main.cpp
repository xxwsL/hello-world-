...
int main()
{
	...
	Image2BinaryData IBD(128,128);											//设置图片大小(Height,Width)
	
	/*------------生成训练集文件--------------------------*/
	printf("----------生成训练集文件-------------\n");
	string trainfilefolder = base_path + "128train39";		//训练图片文件路径
	...
	string trainimagebinfilepath = base_path + "train-images-idx3-ubyte";		//训练图片转换保存路径
	string trainlabelbinfilepath = base_path + "train-labels-idx1-ubyte";		//训练标签转换保存路径
	...
	/*------------生成测试集文件--------------------------*/
	printf("\n\n----------生成测试集文件-------------\n");
	string testfilefolder = base_path + "128test39";		//测试图片文件路径
	...
	string testimagebinfilepath = base_path + "t10k-images-idx3-ubyte";		//测试图片转换保存路径
	string testlabelbinfilepath  = base_path + "t10k-labels-idx1-ubyte";		//测试标签转换保存路径
