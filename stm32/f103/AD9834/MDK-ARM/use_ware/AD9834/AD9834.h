...
#define AD9834_FSYNC  	 		GPIO_PIN_1    	//A3
#define AD9834_SCLK   		 	GPIO_PIN_3		//A4
#define AD9834_SDATA  		 	GPIO_PIN_5 		//A5
#define AD9834_RESET  			GPIO_PIN_7		//A6
#define AD9834_FS  				GPIO_PIN_2		//B0
#define AD9834_PS  				GPIO_PIN_4		//B1

#define AD9834_FSYNC_SET   PAout(1)=1 

#define AD9834_FSYNC_CLR   PAout(1)=0 

#define AD9834_SCLK_SET    PAout(3)=1 

#define AD9834_SCLK_CLR    PAout(3)=0 

#define AD9834_SDATA_SET   PAout(5)=1 

#define AD9834_SDATA_CLR   PAout(5)=0 

#define AD9834_RESET_SET   PAout(7)=1

#define AD9834_RESET_CLR   PAout(7)=0 
