...
bool ROI_AddImage()
{
	...
	//【1】读入图像  
	Mat srcImage1 = imread("E:\\图片仓库\\世界末日\\opencv_test0\\3.jpg");
	Mat logoImage = imread("E:\\图片仓库\\世界末日\\opencv_test3\\4.jpg");
	...
	//【3】加载掩模（必须是灰度图）  
	Mat mask = imread("E:\\图片仓库\\世界末日\\opencv_test3\\4.jpg");
...
bool LinearBlending()
{
	...
	srcImage2 = imread("E:\\图片仓库\\世界末日\\opencv_test2\\0.jpg");
	srcImage3 = imread("E:\\图片仓库\\世界末日\\opencv_test2\\1.jpg");
...
bool ROI_LinearBlending()
{
	...
	//【1】读取图像  
	Mat srcImage4 = imread("E:\\图片仓库\\世界末日\\opencv_test0\\3.jpg", 1);
	Mat logoImage = imread("E:\\图片仓库\\世界末日\\opencv_test3\\4.jpg");
