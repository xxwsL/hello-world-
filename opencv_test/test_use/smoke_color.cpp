...
bool MultiChannelBlending()
{
	...
	//【1】读入图片  
	logoImage = imread("E:\\图片仓库\\世界末日\\矢量素材\\矢量6.jpg", 0);
	srcImage = imread("E:\\图片仓库\\世界末日\\矢量素材\\矢量6.jpg");
	...
	//addWeighted(imageBlueChannel(Rect(100, 20, logoImage.cols, logoImage.rows)), 1.0,
	//	logoImage, 0.5, 0, imageBlueChannel(Rect(100, 20, logoImage.cols, logoImage.rows)));
